...
class GetTrailer extends React.Component {
  ...
  render(){
    return (
      ...
      <div>
        {this.state.moviedbID && this.state.youtubeID &&
          <iframe width="560" height="315" src={`https://www.youtube.com/embed/${this.state.youtubeID}`} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        }
        <a href={`http://www.youtube.com/watch?v=${this.state.youtubeID}`}> Trailer </a>
      </div>
